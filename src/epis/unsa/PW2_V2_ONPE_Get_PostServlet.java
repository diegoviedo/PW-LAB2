...
public class PW2_V2_ONPE_Get_PostServlet extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		//req.setAttribute("poblacion", poblacion1);
		...
		for(int i=0;i<poblacion1.size();i++){
			...
			if(poblacion1.get(i).getDni()==dniNum){
				//CODIGO
				out.println(
				...
				+ ".centro {margin:10px 10px 10px 10px;"
				+ "			height: 500px;"
				+ "			width: 1000px;"
				...
				+ "	</div>"
				+ "<div class='der'><p class='gris'><b>DNI:"+poblacion1.get(i).getDni()+"</b></p>"
				+ "</div></div>"
				+ "<div class='cuadro'><p class='gris'>Nombres:</p>"
				+ "	<p class='azul'><b>"+poblacion1.get(i).getNombre()+"</b></p></div>"
				+ "<div class='cuadro'>"
				+ "<p class='gris'>Apellidos:</p>"
				
				+ "	<p class='azul'><b>"+poblacion1.get(i).getApellidos()+"</b></p></div>"
				+ "	<div class='cuadro1'><p class='rojo'><b>"+poblacion1.get(i).getMienbroMesa()+"</b><p></div>"
				+ "</div>"
				+ "	<div class='bloque'><div class='cuadro'><p class='naranja'><b>AREQUIPA/AREQUIPA/AREQUIPA</b></p>"
				+ "</div>"
				+ "<div class='cuadro'>"
				+ "	<p class='gris'><b>Mesa de Sufragio</b></p><p class='azul'><b>"+poblacion1.get(i).getMesaSufragio()+"</b></p></div>"
				+ "<div class='cuadro'><p class='gris'>Local de Votacion:</p><p class='azul'><b>"+poblacion1.get(i).getLocalVotacion()+"</b></p></div>"
				+ "<div class='cuadro'>	<div class='cuadritoizq'><p class='gris'>Pabellon:</p><p class='azul'><b>"+poblacion1.get(i).getPabellon()+"</b></p>"
				+ "</div><div class='cuadritoizq'><p class='gris'>Piso:</p>	<p class='azul'><b>"+poblacion1.get(i).getPiso()+"</b></p></div>"
				+ "	<div class='cuadritoizq3'><p class='gris'>Aula:</p>	<p class='azul'><b>"+poblacion1.get(i).getAula()+"</b></p></div>"
				+ "	</div>"
				...
				+ "	<div class='cuadro'>"
				+ "	<p class='azul'><b>"+poblacion1.get(i).getDireccion()+"</b></p></div></div></div>"
				+ "	</center>"
